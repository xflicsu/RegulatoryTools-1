...
## Enhancer & target 
- [JEME](https://github.com/yiplabcuhk/JEME/)
...
- [ABC](https://github.com/mlupien/ABC)

##  allele-specific expression and chromatin modifications (imprinted expression)
- [Allelome.PRO](https://sourceforge.net/projects/allelomepro/)

## allele binding & expression
- [AlleleDB](http://alleledb.gersteinlab.org/download/)

## Motif breaking effect
- [atSNP](https://github.com/chandlerzuo/atSNP)
